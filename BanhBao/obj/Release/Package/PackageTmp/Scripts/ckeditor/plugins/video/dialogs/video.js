				...
				[
					{
					    ...
					    children: [
							...
							},
							{
							    ...
							    onClick: function () {
							        window.open('/FileManager/default.aspx?function=insertImageVideo&mode=single&share=share&i=', 'Image Browser', 'width=900,height=700,scrollbars,resizable=yes,status=yes');
							    }
							}]
					},
					{
					...
					},
					{
					    ...
					    children: [
							...
							},
							{
							    ...
							    label: editor.lang.common.browseServer,
							    onClick: function () {
							        window.open('/FileManager/default.aspx?function=insertVideoMp4&mode=single&share=share&i=', 'Image Browser', 'width=900,height=700,scrollbars,resizable=yes,status=yes');
							    }
							},
							{
							    id: 'type0',
...
function insertImageVideo(arrImage) {
    if (arrImage.length > 0) {
        $(".divUrlImage :text").each(function () {
            $(this).val(arrImage[0]);
        });
    }
}
function insertVideoMp4(arrImage) {
     if (arrImage.length > 0) {
        $(".divVideo0 :text").each(function () {
            $(this).val(arrImage[0]);
        });
    }
}
